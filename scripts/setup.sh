$HOME/ubuntu_setup/scripts/install_packages.sh
$HOME/ubuntu_setup/scripts/git-config.sh
$HOME/ubuntu_setup/scripts/create_sym_links.sh
$HOME/ubuntu_setup/scripts/config_bash.sh
